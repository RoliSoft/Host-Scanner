...
wget https://github.com/RoliSoft/Host-Scanner-Scripts/releases/download/v0.1.0/cpe-list.dat.gz
...
wget https://github.com/RoliSoft/Host-Scanner-Scripts/releases/download/v0.1.0/cve-list.dat.gz