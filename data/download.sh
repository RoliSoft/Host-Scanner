...
wget https://github.com/RoliSoft/Host-Scanner-Scripts/releases/download/v0.2.0/cpe-list.dat.gz
...
wget https://github.com/RoliSoft/Host-Scanner-Scripts/releases/download/v0.2.0/cve-list.db3.bz2
